...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "landcounter" because\n';
  ...
  $wnd.__gwt_activeModules['landcounter'] = {
    'moduleName' : 'landcounter',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/landcounter.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['landcounter'].superdevmode = true;

  var expectedSuffix = '/landcounter.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + landcounter + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:landcounter';
  var devModeSessionKey = '__gwtDevModeSession:landcounter';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/landcounter/landcounter.nocache.js';
  ...
  $wnd.__gwt_activeModules['landcounter'].canRedirect = true;
  $wnd.__gwt_activeModules['landcounter'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/landcounter?user.agent=' + ua + '&_callback=' + callback;
